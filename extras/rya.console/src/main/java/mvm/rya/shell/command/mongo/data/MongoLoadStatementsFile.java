...
public class MongoLoadStatementsFile extends MongoCommand implements LoadStatementsFile {
    ...
    /**
     * Constructs an instance of {@link MongoLoadStatementsFile}.
     *
     * @param connectionDetails - Details about the values that were used to create the connector to the cluster. (not null)
     * @param client - Provides programatic access to the instance of Mongo
     *   that hosts Rya instance. (not null)
     */
    public MongoLoadStatementsFile(final MongoConnectionDetails connectionDetails,final MongoClient client) {
