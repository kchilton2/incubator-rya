...
/**
 * An Mongo implementation of the {@link LoadStatement} command.
 */
@ParametersAreNonnullByDefault
public class MongoLoadStatement extends MongoCommand implements LoadStatement {

    /**
     * Constructs an instance of {@link MongoLoadStatement}.
     *
     * @param connectionDetails - Details about the values that were used to create the connector to the cluster. (not null)
     * @param client - Provides programatic access to the instance of Mongo
     *   that hosts Rya instance. (not null)
     */
    public MongoLoadStatement(final MongoConnectionDetails connectionDetails, final MongoClient client) {
