...
import mvm.rya.shell.FluoITBase;
...
public class AccumuloDeletePCJIT extends FluoITBase {
    ...
    @Test
    public void deletePCJ() throws InstanceDoesNotExistException, CommandException, PCJStorageException, RepositoryException {
    ...
    public void deletePCJ_instanceDoesNotExist() throws InstanceDoesNotExistException, CommandException {
        final AccumuloConnectionDetails connectionDetails = new AccumuloConnectionDetails(
                ACCUMULO_USER,
                ACCUMULO_PASSWORD.toCharArray(),
                super.cluster.getInstanceName(),
    ...
    public void deletePCJ_pcjDoesNotExist() throws InstanceDoesNotExistException, CommandException {
        final AccumuloConnectionDetails connectionDetails = new AccumuloConnectionDetails(
                ACCUMULO_USER,
                ACCUMULO_PASSWORD.toCharArray(),
                super.cluster.getInstanceName(),
