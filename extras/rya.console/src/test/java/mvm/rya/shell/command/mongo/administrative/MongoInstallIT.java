...
public class MongoInstallIT extends MongoITBase {
    ...
    @Test
    public void install() throws MongoException, DuplicateInstanceNameException, CommandException, NotInitializedException, RyaDetailsRepositoryException {
    ...
    public void install_alreadyExists() throws DuplicateInstanceNameException, CommandException, MongoException {
        // Install an instance of Rya.
        final String instanceName = "testInstance_";
