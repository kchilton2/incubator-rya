...
public class AccumuloCreatePCJIT extends FluoITBase {
    ...
    public void createPCJ_instanceDoesNotExist() throws InstanceDoesNotExistException, CommandException {
        final AccumuloConnectionDetails connectionDetails = new AccumuloConnectionDetails(
                ACCUMULO_USER,
                ACCUMULO_PASSWORD.toCharArray(),
                super.cluster.getInstanceName(),
    ...
    public void createPCJ_invalidSparql() throws DuplicateInstanceNameException, CommandException {
