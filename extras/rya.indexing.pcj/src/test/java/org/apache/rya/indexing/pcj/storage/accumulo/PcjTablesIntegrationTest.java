...
//    private static MiniAccumuloClusterInstance cluster = new MiniAccumuloClusterInstance();
//
...
//
//    @BeforeClass
//    public static void setupMiniCluster() throws IOException, InterruptedException, AccumuloException, AccumuloSecurityException {
//        cluster.startMiniAccumulo();
//    }
//
//    @Before
//    public void resetTestEnvironmanet() throws AccumuloException, AccumuloSecurityException, TableNotFoundException, RepositoryException {
//        // Clear all the tables that were added by the last test from the mini cluster.
...
//
//    @AfterClass
//    public static void shutdownMiniCluster() throws IOException, InterruptedException {
...
//     */
//    private static RyaSailRepository setupRya() throws AccumuloException, AccumuloSecurityException, RepositoryException {
