...
public abstract class RyaSinkTask extends SinkTask {
     ...
     * @throws IllegalStateException The configured Rya Instance is not installed to the configured database
     *   or we were unable to figure out if it is installed.
     */
    protected abstract void checkRyaInstanceExists(final Map<String, String> taskConfig) throws IllegalStateException;

    /**
     * Creates an uninitialized {@link Sail} object that may be used to write {@link Statement}s to the configured
     * Rya Instance.
     *
     * @param taskConfig - Configures how the Sail object will be created. (not null)
     * @return The created Sail object.
     */
    protected abstract Sail makeSail(final Map<String, String> taskConfig);
    ...
    @Override
    public void start(final Map<String, String> props) throws IllegalStateException {
        ...
        sailRepo = new SailRepository( makeSail(props) );
        sailRepo.initialize();
    ...
    public void put(final Collection<SinkRecord> records) {
        ...
        for(final SinkRecord record : records) {
            ...
            conn.add((Set<Statement>) record.value());
        }
    }
